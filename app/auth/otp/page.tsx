...
function OtpPageInner() {
  ...
  return (
    <div className="flex h-full flex-col">
      <Header title="Verify your number" subtitle={`Enter the 6-digit code sent to ${phone || "your phone"}`} />
      ...
      <div className="flex-1 overflow-y-auto px-5 pb-6 pt-2">
        ...
        />
        <button
          onClick={() => push({ kind: "info", title: "Code resent", message: `A new code was sent to ${phone}.` })}
